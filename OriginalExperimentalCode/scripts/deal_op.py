...
def read_results(dataset, metric_name):
    ...
    data.to_excel(save_dir / f'{dataset}_optimization_{metric_name}.xlsx')



if __name__ == '__main__':
    read_results(dataset='sub_15_repeat_0', metric_name='f1')
    read_results(dataset='sub_15_repeat_0', metric_name='recall')
    read_results(dataset='sub_15_repeat_0', metric_name='precision')
