...
from scripts.deep_for_new_sub_15 import Comparator as DeepComparator
...
parser.add_argument('--mod', type=str, default='debug')
...
if __name__ == '__main__':
    for (dataset_name, split_list) in gd.get_all():
        ...
        # # 指定sub数据集
        if f'sub_1_' not in dataset_name:
            continue
        ...
        if mod == 'deep':
            deep_cp = DeepComparator(
                ...
                process_num=multiprocessing.cpu_count()-1 if only_model == 'sann' else 1,
